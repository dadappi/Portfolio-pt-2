          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="order-2 lg:order-1">
                <div className="relative aspect-video bg-gradient-to-br from-orange-500/10 to-teal-500/10 rounded-2xl overflow-hidden border border-border">
                  {project.image ? (
                    <img
                      src={project.image}
                    ...
                    <div className="w-full h-full flex items-center justify-center">
                      <Code className="w-16 h-16 text-orange-500/50" aria-hidden="true" />
                    </div>
                  )}
                ...
                <div className="flex flex-wrap gap-2 mb-6" role="list" aria-label="Tech stack">
                  {project.techStack.map((tech, i) => (
                    <motion.span
                      ...
                      className="px-3 py-1 text-sm bg-orange-500/10 text-orange-500 rounded-lg border border-orange-500/20"
                      role="listitem"
                    >
                      {tech}
                    </motion.span>
                ...
                <div className="flex flex-wrap gap-4">
                  {project.linkDemo && (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-orange-500 to-teal-500 text-white rounded-full font-medium hover:from-orange-600 hover:to-teal-600 transition-all shadow-lg shadow-orange-500/25"
                  ...
                  {project.linkGithub && (
                    <motion.a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-2 px-5 py-2.5 bg-bg-elevated text-text border border-border rounded-lg font-medium hover:border-orange-500/50 hover:bg-orange-500/10 hover:text-orange-500 transition-all"
                      whileHover={{ y: -2, scale: 1.02 }}
                      whileTap={{ scale: 0.98 }}
                    >
