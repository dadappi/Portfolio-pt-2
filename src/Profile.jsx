...
const skillCategories = [
  { key: 'frontend', label: 'Frontend', icon: Globe, color: 'from-orange-500 to-rose-400' },
  { key: 'backend', label: 'Backend', icon: Server, color: 'from-teal-500 to-blue-500' },
  ...
  { key: 'tools', label: 'Tools', icon: Code, color: 'from-amber-500 to-orange-500' },
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          ...
          >
            <div className="relative aspect-square max-w-xs mx-auto">
              <div className="absolute inset-0 bg-gradient-to-br from-orange-500/30 to-teal-500/30 rounded-2xl blur-2xl" aria-hidden="true" />
              <div className="relative bg-bg-elevated border border-border rounded-2xl p-1 aspect-square">
                <div className="relative aspect-square rounded-xl overflow-hidden bg-gradient-to-br from-orange-500/10 to-teal-500/10 flex items-center justify-center">
                  {profile.photo ? (
                    <img src={profile.photo} alt={profile.name} className="w-full h-full object-cover" />
                  ) : (
                    <div className="w-32 h-32 rounded-full bg-gradient-to-br from-orange-500 to-teal-500 flex items-center justify-center">
              ...
              <motion.div
                ...
                className="absolute -inset-4 border-2 border-orange-500/20 rounded-3xl"
                aria-hidden="true"
              />
            </div>
                  ...
                  <motion.button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-medium transition-all flex items-center gap-2 ${
                      activeTab === cat.key
                        ...
                        : 'bg-bg-elevated text-text-muted hover:text-text hover:border-orange-500/50 border border-border'
                    } ${cat.color}`}
                    whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.97 }}
              ...
              >
                {tools.map((tool, i) => (
                  <motion.div
                    ...
                    className="bg-bg-elevated border border-border rounded-lg p-4 hover:border-orange-500/50 transition-all group"
                  >
                    ...
                    <div className="h-1.5 bg-border rounded-full overflow-hidden">
                      <motion.div
                        ...
                        className="h-full bg-gradient-to-r from-orange-500 to-teal-500 rounded-full group-hover:from-teal-500 group-hover:to-orange-500 transition-all duration-300"
                      />
                    </div>
                  </motion.div>
                ))}
            ...
            >
              {[
                ...
                <motion.div
                  ...
                  className="bg-bg-elevated border border-border rounded-xl p-6 text-center hover:border-orange-500/50 transition-all"
                >
