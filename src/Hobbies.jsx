            ...
            >
              <div className="flex items-start gap-4 mb-4">
                <motion.div
                  ...
                  className="w-14 h-14 rounded-xl bg-gradient-to-br from-orange-500/20 to-teal-500/20 flex items-center justify-center text-orange-500 group-hover:from-orange-500/30 group-hover:to-teal-500/30 transition-all"
                >
                  {getIcon(hobby.icon)}
                </motion.div>
                ...
                <div className="flex flex-wrap gap-3 pt-4 border-t border-border">
                  {(hobby.images || []).map((img, i) => (
                    <motion.a
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 text-xs text-text-muted hover:text-orange-500 bg-orange-500/10 rounded-lg border border-orange-500/20 transition-colors"
                      whileHover={{ x: 2 }}
                    >
