...
import { Turtle, WaveDivider } from './Decor'
...
export default function Contact() {
  ...
  const socialLinks = [
    { href: `mailto:${profile.contact?.email || ''}`, icon: Mail, label: 'Email', color: 'from-red-500 to-rose-400' },
  ...
  return (
    <section
      id="contact"
      className="relative py-24 md:py-32 bg-gradient-to-b from-bg via-bg-elevated/50 to-bg"
      aria-labelledby="contact-title"
    >
      <div className="absolute top-0 left-0 right-0 -translate-y-[calc(100%-1px)]">
        <WaveDivider color="var(--color-bg-elevated)" />
      </div>
      <div className="section-container">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          >
            ...
            <div className="space-y-4 mb-10">
              {socialLinks.map((social, i) => (
                <motion.a
                  ...
                  className="group flex items-center gap-4 p-4 bg-bg-elevated border border-border rounded-xl hover:border-orange-500/50 transition-all"
                  whileHover={{ x: 4 }}
                >
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center bg-gradient-to-br ${social.color} text-white`}>
            ...
            <div className="p-5 bg-gradient-to-r from-orange-500/10 to-teal-500/10 border border-orange-500/20 rounded-xl">
              ...
              <div className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 bg-bg border border-border rounded-lg text-text placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-transparent transition-all"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full px-4 py-3 bg-bg border border-border rounded-lg text-text placeholder-text-muted focus:outline-none focus:ring-2 focus:ring-orange-500/50 focus:border-transparent transition-all resize-none"
                ...
                <motion.button
                  ...
                  className="w-full py-3 px-6 bg-gradient-to-r from-orange-500 to-teal-500 text-white rounded-full font-medium hover:from-orange-600 hover:to-teal-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
        ...
        <motion.div
          ...
          className="mt-16 text-center flex flex-col items-center gap-3"
        >
          <Turtle className="w-10 h-10 opacity-80" />
